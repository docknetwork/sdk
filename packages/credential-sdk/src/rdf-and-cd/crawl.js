...
import { deepClone, assertValidNode } from './common';
import { queryNextLookup, parseRDFDocument } from './rdf';
import { inferh } from './cd';
import { canon } from './canonicalize';
import { Namer, fromJsonldjsCg } from './claimgraph';
...
async function jsonldToCg(jld, documentLoader) {
  ...
  for (const claim of cg) {
    assert(
      ...
      'illegal subgraph was specified',
    );
    claim.pop();
