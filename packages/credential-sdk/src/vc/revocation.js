...
export function getDockRevIdFromCredential(credential) {
  ...
  return u8aToHex(blake2b(credential[credentialIDField], RevEntryByteSize * 8));
}
 ...
 * @returns {boolean}
 */
export const isAccumulatorRevocationStatus = ({
  [credentialTypeField]: type,
}) => ACCUMULATOR_LD_TYPES.some((t) => type.includes(t));
