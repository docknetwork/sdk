...
import { documentLoader } from "./utils/cached-document-loader.js";
...
describe("logic", () => {
  test("delegation chain", async () => {
    ...
    assert_error(() => proveh(cg, to_prove, MAYCLAIM_DEF_1), {
      CantProve: "NovelName",
    });
    assert_error(() => proveh(cg, to_prove, MAYCLAIM_DEF_2), {
