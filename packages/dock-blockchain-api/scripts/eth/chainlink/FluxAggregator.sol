// Generated with solidity-flattener for https://github.com/smartcontractkit/chainlink/blob/develop/evm-contracts/src/v0.6/FluxAggregator.sol
...
contract FluxAggregator is AggregatorV2V3Interface, Owned {
  ...
  // This is set even if one oracle submits a valid answer.
  uint32 private reportingRoundId;
  // This is set when at least minimum number of oracles respond.
    ...
    external
  {
    ...
    // Question: Why is validate done at the end?
    if (updated) {
  ...
  /**
    @notice Update round information if it timed out
  */
    ...
    private
  {
    ...
    // If round did time out, its answer should be same as previous round
  ...
  /**
    @notice Updates round answer only when there are at least minimum submissions
  */
  ...
  /**
    @notice Update Oracle's withdrawable funds
  */
  ...
  /**
    @notice Maximum submissions have been received for this round so delete its details so that more submissions for this round are no longer accepted.
  */
  ...
  /**
    @notice Check if _roundId corresponds to the previous round and current round has had no submissions
  */
  ...
  /**
    @notice Check if oracle can participate in this round or start the round yet or reporting in previous rounds or reporting twice.
  */
  ...
  /**
    @notice Check if max submissions have been reached for this round. Max submissions are set to 0 once they are reached.
  */
  ...
  /**
    @notice If the oracle has waited for the appropriate time before initializing a new round
  */
