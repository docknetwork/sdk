...
export function getTestPrivKeysForEVMAccounts() {
  ...
  const dave =
    "0x348ce564067fba3f6fc2050643379e190e087aeffe5d958ab9f2f3ed31dcd098";
...
export async function endowEVMAddressWithDefault(
  evmAddr,
  amount,
  nodeEndpoint,
  accountUri
...
export async function sendEVMTxn(
  web3,
  signer,
  to,
  bytecode,
...
export async function sendTokensToEVMAddress(
  web3,
  signer,
  to,
  amount,
