...
describe("Accumulator Module", () => {
  ...
  beforeAll(async (done) => {
    ...
    await dock.did.new(
      ...
      createKeyDetail(
        ...
        /*dock.api.registry.createType("Did", */ getHexIdentifierFromDID(did1) //)
      ),
      false
    );
    await dock.did.new(
      ...
      createKeyDetail(
        ...
        /*dock.api.registry.createType("Did",*/ getHexIdentifierFromDID(did2) //)
      ),
      false
    );
  ...
  test("Can create new params", async () => {
    ...
    const params3 = chainModule.prepareAddParameters(bytes3);
    await chainModule.createNewParams(
      params3,
      getHexIdentifierFromDID(did1),
      pair1,
  ...
  test("Can add and remove accumulator", async () => {
    ...
    expect(accum2WithKeyAndParams.key_ref).toEqual([
      getHexIdentifierFromDID(did2),
      1,
    ]);
