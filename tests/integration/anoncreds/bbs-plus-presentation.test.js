...
import { initializeWasm, BBSPlusSecretKey, BBSPlusPublicKeyG2, SignatureParamsG1 } from '@docknetwork/crypto-wasm-ts';
...
const embeddedSchema1 = {
  id: `data:application/json;charset=utf-8,${encodeURIComponent(JSON.stringify(residentCardSchema1))}`,
  type: 'JsonSchemaValidator2018',
};
...
const credentialJSON1 = {
  ...credentialJSONWithoutSchema,
  credentialSchema: embeddedSchema1,
};
