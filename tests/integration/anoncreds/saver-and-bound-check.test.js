...
describe('Complete demo of verifiable encryption using SAVER and bound check using LegoGroth16', () => {
  ...
  test('Create BBS+ params and keys', async () => {
    ...
    await dock.bbsPlusModule.addParams(params, getHexIdentifierFromDID(issuerDid), issuerKeypair, undefined, false);
    ...
    await dock.bbsPlusModule.addPublicKey(pk, getHexIdentifierFromDID(issuerDid), issuerKeypair, undefined, false);
  }, 10000);
