...
describe('DID controllers', () => {
  ...
  test('Get DID documents', async () => {
    ...
    expect(doc1.verificationMethod.length).toEqual(1);
    expect(doc1.verificationMethod[0].id).toEqual(`${dockDid1}#keys-1`);
    expect(doc1.verificationMethod[0].controller).toEqual(dockDid1);
    expect(doc1.verificationMethod[0].publicKeyMultibase).toBeDefined();
    ...
    expect(doc2.verificationMethod.length).toEqual(3);
    expect(doc2.verificationMethod[0].id).toEqual(`${dockDid2}#keys-1`);
    expect(doc2.verificationMethod[0].controller).toEqual(dockDid2);
    expect(doc2.verificationMethod[0].publicKeyMultibase).toBeDefined();
    expect(doc2.verificationMethod[1].id).toEqual(`${dockDid2}#keys-2`);
    expect(doc2.verificationMethod[1].controller).toEqual(dockDid2);
    expect(doc2.verificationMethod[1].publicKeyMultibase).toBeDefined();
    expect(doc2.verificationMethod[2].id).toEqual(`${dockDid2}#keys-3`);
    expect(doc2.verificationMethod[2].controller).toEqual(dockDid2);
    expect(doc2.verificationMethod[2].publicKeyMultibase).toBeDefined();
