...
describe("Fees", () => {
  ...
  test("dids", async () => {
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.did.addKeys([dk3], did, did, pair, 1, undefined, false);
    });
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.did.addKeys([dk4], did, did, pair, 1, undefined, false);
    });
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.did.addKeys([dk5, dk6], did, did, pair, 1, undefined, false);
    });
    ...
    // Add 1 controller
    await withPaidFeeMatchingSnapshot(() => {
      return dock.did.addControllers(
        [newControllers[0]],
        did,
        did,
        pair,
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.did.addServiceEndpoint(
        spId1,
        spType,
        origins1,
        did,
    ...
    // Removing 1 key
    await withPaidFeeMatchingSnapshot(() => {
      return dock.did.removeKeys([2], did, did, pair, 1, undefined, false);
    });

    // Removing 2 keys
    await withPaidFeeMatchingSnapshot(() => {
      return dock.did.removeKeys([3, 4], did, did, pair, 1, undefined, false);
    });

    // Removing 1 controller
    await withPaidFeeMatchingSnapshot(() => {
      return dock.did.removeControllers(
        [newControllers[0]],
        did,
        did,
        pair,
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.did.removeServiceEndpoint(
        spId1,
        did,
        did,
        pair,
    ...
    // Remove DID
    await withPaidFeeMatchingSnapshot(() => {
      return dock.did.remove(did, did, pair, 1, undefined, false);
    });
  }, 40000);
  ...
  test("revocation", async () => {
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.revocation.newRegistry(registryId, policy, false, false);
    });
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.signAndSend(revTx, false);
    });
  }, 40000);
  ...
  test("anchors", async () => {
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.anchor.deploy(anc, false);
    });
  }, 30000);
  ...
  test("blobs", async () => {
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.blob.new(blob, did, pair, 1, { didModule: dock.did }, false);
    });
  }, 30000);
  ...
  test("bbsPlus", async () => {
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.bbsPlusModule.addPublicKey(
        pk,
        did,
        did,
        pair,
    ...
    // Remove public key
    await withPaidFeeMatchingSnapshot(() => {
      return dock.bbsPlusModule.removePublicKey(
        2,
        did,
        did,
        pair,
    ...
    // Remove params
    await withPaidFeeMatchingSnapshot(() => {
      return dock.bbsPlusModule.removeParams(
        1,
        did,
        pair,
        1,
  ...
  test("accumulator", async () => {
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.accumulatorModule.addParams(
        params,
        did,
        pair,
        1,
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.accumulatorModule.addPublicKey(
        pk,
        did,
        pair,
        1,
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.accumulatorModule.addPositiveAccumulator(
        accumulatorIdPos,
        accumulatedPos,
        [did, 1],
        did,
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.accumulatorModule.addUniversalAccumulator(
        accumulatorIdUni,
        accumulatedUni,
        [did, 1],
        10000,
    ...
    await withPaidFeeMatchingSnapshot(() => {
      return dock.accumulatorModule.removeAccumulator(
        accumulatorIdPos,
        did,
        pair,
        1,
