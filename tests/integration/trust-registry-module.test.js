...
buildTest('Trust Registry', () => {
  ...
  it('Adds schemas metadata to the existing Trust Registry', async () => {
    ...
    const schemas = new BTreeMap(dock.api.registry, 'TrustRegistrySchemaId');
    schemas.set(schemaId, {
      Set: {
        issuers,
        verifiers,
  ...
  it('Removes schemas metadata from the Trust Registry', async () => {
    ...
    let schemas = new BTreeMap(dock.api.registry, 'TrustRegistrySchemaId');
    schemas.set(schemaId, {
      Add: {
        issuers,
        verifiers,
    ...
    schemas = new BTreeMap(dock.api.registry, 'TrustRegistrySchemaId');
  ...
  it('Updates schemas metadata in the existing Trust Registry', async () => {
    ...
    let schemasUpdate = new BTreeMap(dock.api.registry, 'TrustRegistrySchemaId');
    ...
    schemasUpdate = new BTreeMap(dock.api.registry, 'TrustRegistrySchemaId');
  ...
  it('Overrides Trust Registry', async () => {
    ...
    await dock.trustRegistry.setSchemasMetadata(
      convenerDID,
      trustRegistryId,
      { Set: new BTreeMap(dock.api.registry, 'TrustRegistrySchemaId') },
      convenerPair,
      dock,
    );
