...
describe("ensureMatchesStructurePattern", () => {
  test("$matchType", () => {
    ...
    expect(() =>
      ensureMatchesStructurePattern(pat, "sasda")
  ...
  test("$matchObject", () => {
    ...
    expect(() =>
      ensureMatchesStructurePattern(pat, { c: 3 })
    ).toThrowErrorMatchingSnapshot();
    expect(() =>
      ensureMatchesStructurePattern(pat, { a: 3 })
    ).toThrowErrorMatchingSnapshot();
    expect(() =>
      ensureMatchesStructurePattern(pat, { a: 1, b: 3 })
    ).toThrowErrorMatchingSnapshot();
  ...
  test("$matchIterable", () => {
    ...
    expect(() =>
      ensureMatchesStructurePattern(pat, [3])
    ).toThrowErrorMatchingSnapshot();
    expect(() =>
      ensureMatchesStructurePattern(pat, [1, 3])
    ).toThrowErrorMatchingSnapshot();
    expect(() =>
  ...
  test("$instanceOf", () => {
    expect(() =>
      ensureMatchesStructurePattern({ $instanceOf: Function }, {})
    ).toThrowErrorMatchingSnapshot();
  ...
  test("$iterableOf", () => {
    ...
    expect(() =>
      ensureMatchesStructurePattern(pat, [1, 2])
    ).toThrowErrorMatchingSnapshot();
  ...
  test("$mapOf", () => {
    ...
    expect(() =>
      ensureMatchesStructurePattern(pat, new Map([[1, 3]]))
    ).toThrowErrorMatchingSnapshot();
    expect(() =>
      ensureMatchesStructurePattern(pat, new Map([[3, 2]]))
    ).toThrowErrorMatchingSnapshot();
    expect(() =>
  ...
  test("$mapOf", () => {
    ...
    expect(() =>
      ensureMatchesStructurePattern(pat, { A: 5 })
    ).toThrowErrorMatchingSnapshot();
    expect(() =>
      ensureMatchesStructurePattern(pat, { B: 1 })
    ).toThrowErrorMatchingSnapshot();
    expect(() =>
      ensureMatchesStructurePattern(pat, { A: 1, B: 3 })
    ).toThrowErrorMatchingSnapshot();
